      ...
      <Form.Item shouldUpdate={(prevValues, curValues) => prevValues.type !== curValues.type} noStyle>
        {({ getFieldValue }) => {
          ...
          if (type === 'query') {
            ...
            return (
              <Form.Item label={t('默认值')} name='defaultValue'>
                ...
                <Col flex='70px'>
                  <Form.Item shouldUpdate={(prevValues, curValues) => prevValues.multi !== curValues.multi} noStyle>
                    {({ getFieldValue }) => {
                      ...
                      if (multi) {
                        return (
                          <Form.Item label={t('包含全选')} name='allOption' valuePropName='checked'>
                            <Switch />
                          </Form.Item>
                        );
                      }
                ...
                <Col flex='auto'>
                  <Form.Item shouldUpdate noStyle>
                    {({ getFieldValue }) => {
                      ...
                      if (multi && allOption) {
                        return (
                          <Form.Item label={t('自定义全选值')} name='allValue'>
                            <Input placeholder='.*' />
                          </Form.Item>
                        );
                      }
