      ...
      return <>
            ...
            return <Panel header={<Form.Item noStyle shouldUpdate>
                    ...
                    <Row gutter={10}>
                      ...
                      <Col span={12}>
                        <Form.Item label={<span>
                            ...
                            </span>} {...field} name={[field.name, 'query', 'filter']}>
                          <Input />
                        </Form.Item>
                      </Col>
                    </Row>
                ...
                return !_.isEqual(prevValues.datasourceName, curValues.datasourceName);
                  ...
                  const datasourceName = getFieldValue('datasourceName') ? [getFieldValue('datasourceName')] : [];
                  return <>
                            <Values prefixField={field} prefixFields={['targets']} prefixNameField={[field.name]} cate={getFieldValue('datasourceCate')} cluster={datasourceName} index={getFieldValue([...prefixName, 'query', 'index'])} valueRefVisible={false} />
                            <Form.Item shouldUpdate={(prevValues, curValues) => {
                      ...
                      return !_.isEqual(preQueryValues, curQueryValues);
                        ...
                        return <GroupBy prefixField={field} prefixFields={['targets']} prefixNameField={[field.name, 'query']} cate={getFieldValue('datasourceCate')} cluster={datasourceName} index={getFieldValue([...prefixName, 'query', 'index'])} />;
                      }}
                            </Form.Item>
                          </>;
                }}
