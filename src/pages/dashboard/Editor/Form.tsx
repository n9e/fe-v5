...
function FormCpt(props, ref) {
  ...
  return <Form layout='vertical' form={chartForm} initialValues={_.merge({}, defaultValues, initialValues)}>
                ...
                return <div style={{
                  ...
                  overflowY: 'auto'
                    ...
                    marginBottom: 10
                        ...
                        <VariableConfig onChange={(value, bool, withOptions) => {
                      setVariableConfigWithOptions(withOptions || []);
                    }} value={variableConfigWithOptions} editable={false} cluster={cluster} range={range} id={id} />
                      </div>
                  ...
                  marginBottom: 0
                    ...
                    <Form.List name={'links'}>
                      ...
                      remove
                        ...
                        return <Space key={key} style={{
                          alignItems: 'flex-start'
                        }}>
                                <Form.Item {...restField} name={[name, 'title']} rules={[{
                            required: true,
                            message: t("链接名称")
                          }]}>
                                ...
                                <Form.Item {...restField} name={[name, 'url']} rules={[{
                            required: true,
                            message: t("链接地址")
                          }]}>
                                  <Mentions prefix='$' split='' style={{
                              width: 260
                            }} placeholder={t("链接地址")}>
                                    {_.map(variableConfigWithOptions, item => {
                                return <Mentions.Option key={item.name} value={item.name}>
