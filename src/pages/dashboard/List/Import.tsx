      ...
      {modalType === 'Import' ? (
        <Form
          ...
          onFinish={(vals) => {
            ...
            createDashboard(busiId, { ...data, configs: data.configs }).then(() => {
              message.success(t('导入成功'));
              refreshList();
              destroy();
            });
      ...
      {modalType === 'ImportGrafana' ? (
        <Form
          ...
          onFinish={(vals) => {
            ...
            createDashboard(busiId, { ...data, tags: '', configs: JSON.stringify(data.configs) }).then(() => {
              message.success(t('导入成功'));
              refreshList();
              destroy();
            });
