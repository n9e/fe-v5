...
export default function index() {
  ...
  return <PageLayout title={t("监控大盘")} icon={<FundViewOutlined />} hideCluster={true}>
      <div style={{
      display: 'flex'
    }}>
        <LeftTree busiGroup={{
        ...
        {busiId ? <div className='dashboards-v2'>
            <Header busiId={busiId} selectRowKeys={selectRowKeys} refreshList={() => {
          ...
          render: (text: string, record: DashboardType) => {
            ...
            return <div className='table-active-text' onClick={() => history.push(`/dashboards/${record.ident || record.id}`)}>
                        {text}
                      </div>;
          }
        }, {
          ...
          render: (text: string[]) => <>
              ...
              return tag ? <Tag color='blue' key={index} style={{
                cursor: 'pointer'
              }} onClick={() => {
          ...
          render: (text: number, record: DashboardType) => {
            ...
            return <div>
                        <Switch checked={text === 1} onChange={() => {
                Modal.confirm({
          ...
          title: t("操作"),
          width: '180px',
          render: (text: string, record: DashboardType) => <div className='table-operator-area'>
              ...
              FormCpt({
                ...
                clusters
                      ...
                      <div className='table-operator-area-normal' onClick={async () => {
              Modal.confirm({
              ...
              Export({
                data: exportDataStringify(exportData)
                      ...
                      <div className='table-operator-area-warning' onClick={async () => {
              Modal.confirm({
          ...
          </div> : <BlankBusinessPlaceholder text={t("监控大盘")} />}
      </div>
    </PageLayout>;
}