...
export default function index() {
  ...
  return <PageLayout title={t("数据源管理")}>
      <div className='srm'>
        <SourceCards sourceMap={pluginList} urlPrefix='help/source' />
        <div className='page-title'>{t("已接入的数据源")}</div>
        {pluginList && <TableSource pluginList={pluginList} nameClick={record => {
        setDetailVisible(true);
        setDetailData(record);
      }} />}
        {detailVisible && <Detail visible={detailVisible} data={detailData} onClose={() => {
