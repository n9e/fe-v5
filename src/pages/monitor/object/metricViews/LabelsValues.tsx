      ...
      {!_.isEmpty(filtersStr) && (
        <div className='n9e-metric-views-labels-values-item'>
          <div
            ...
            onClick={() => {
              setExpaned({ ...expaned, filters: !expaned.filters });
            }}
          >
            {t('前置过滤条件')}
      ...
      {!_.isEmpty(dynamicLabels) && (
        <div className='n9e-metric-views-labels-values-item'>
          <div
            ...
            onClick={() => {
              setExpaned({ ...expaned, dynamicLabels: !expaned.dynamicLabels });
            }}
          >
            {t('动态过滤条件')}
            ...
            <div className='n9e-metric-views-dimensionLabel'>
              <Input.Group compact>
                <Input
                  ...
                  onChange={(e) => {
                    setDimensionLabelsSearch({ ...dimensionLabelsSearch, [dimensionLabel.label]: e.target.value });
                  }}
                />
                          ...
                          <div
                            ...
                            onClick={() => {
                              ...
                              const newDimensionLabels = _.map(dimensionLabels, (item) => {
                                if (item.label === dimensionLabel.label) {
                                  return { ...item, value: _.compact(dimensionLabelValue) };
                                }

                                return item;
                              });

                              onChange({ ...value, dimensionLabels: newDimensionLabels });
                            }}
                          >
                            {item}
                          </div>
