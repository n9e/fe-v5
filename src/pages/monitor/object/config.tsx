export const metricMap: any = {
  CPU: {
    ...
    alias: 'CPU',
    dynamic: true,
    filter: { type: 'substring', value: 'cpu_' },
  },
  MEM: {
    key: 'MEM',
    alias: '内存',
    dynamic: true,
    filter: { type: 'prefix', value: 'mem_' },
  },
  DISK: {
    key: 'DISK',
    alias: '磁盘',
    dynamic: true,
    filter: { type: 'prefix', value: 'disk_' },
  },
  NET: {
    key: 'NET',
    alias: '网络',
    dynamic: true,
    filter: { type: 'prefix', value: 'net_' },
  },
  SYS: {
    key: 'SYS',
    alias: '系统',
    dynamic: true,
    filter: { type: 'prefix', value: 'sys_' },
  },
  PROC: {
    key: 'PROC',
    alias: '进程',
    dynamic: true,
    filter: { type: 'prefix', value: 'proc_' },
  },
  LOG: {
    key: 'LOG',
    alias: '日志',
    dynamic: true,
    filter: { type: 'prefix', value: 'log_,LOG_' },
  },
};
