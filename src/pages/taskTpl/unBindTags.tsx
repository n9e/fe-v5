...
const UnBindTags = props => {
  ...
  return <Modal title={t('tpl.tag.unbind.title')} visible={visible} onOk={handleOk} onCancel={handleCancel}>
      <Form form={form}>
        <FormItem label={t('tpl.tag.unbind.field')} required name="tags" rules={[{
        required: true
      }]}>
          <Select mode="tags">
