  ...
  return (
    <div>
      <div className='table-operate-box'>
        <Space>
          ...
          <Input
            ...
            placeholder={t('模糊搜索表格内容(多个关键词请用空格分隔)')}
            value={searchVal}
      ...
      <Table
        ...
        pagination={{ ...tableProps.pagination, showTotal: showTotal, showSizeChanger: true, showQuickJumper: true, pageSizeOptions: pageSizeOptions }}
      />
    </div>
  );
}
