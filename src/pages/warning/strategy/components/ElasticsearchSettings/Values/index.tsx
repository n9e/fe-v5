...
export default function index({
  ...
  return <Form.List {...prefixField} name={[...prefixNameField, 'query', 'values']}>
      {(fields, {
      add,
      remove
    }) => <div>
              ...
              return <Row gutter={10}>
                        <Col flex='auto'>
                          <Row gutter={10}>
                            ...
                            if (val === 'rawData') {
                              setFields([{
                                ...
                                value: 100
                                    ...
                                    {functions.map(func => <Select.Option key={func} value={func}>
                            ...
                            {func !== 'count' && func !== 'rawData' && <Col span={12}>
                                <InputGroupWithFormItem label='Field key' labelWidth={80}>
                                  <Form.Item {...field} name={[field.name, 'field']} rules={[{
                          required: true,
                          message: t("必须填写 field key")
                        }]}>
                                    <AutoComplete options={_.filter(fieldsOptions, item => {
                            if (search) {
