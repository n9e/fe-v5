      ...
      <Form.Item shouldUpdate noStyle>
        ...
        return <>
              <Form.Item label={t("告警方式")}>
                <Radio.Group buttonStyle='solid' value={getFieldValue('algorithm') === 'holtwinters' ? 'abnormalDetection' : 'threshold'} onChange={e => {
              ...
              {getFieldValue('algorithm') === 'holtwinters' && <>
                  <Form.Item label={t("使用算法")} name='algorithm' style={{
              display: 'none'
            }}>
                    <Select>
                  ...
                  marginTop: 16
                    ...
                    gap: 20
                      ...
                      marginBottom: 16
                            ...
                            <Form.Item noStyle name={['algo_params', 'upper_bound']} valuePropName='checked' getValueFromEvent={e => {
                        return e.target.checked ? 1 : 0;
                          ...
                          <div>
                            <Form.Item noStyle name={['algo_params', 'lower_bound']} valuePropName='checked' getValueFromEvent={e => {
                        return e.target.checked ? 1 : 0;
                      }}>
