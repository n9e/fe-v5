...
export default function index({
  ...
  return <>
      <Form.List {...prefixField} name={[...prefixName, 'queries']} initialValue={[{
      ref: 'A'
    }]}>
        {(fields, {
        add,
                ...
                return <>
                          ...
                          width: 32
                            ...
                            <Col flex='auto'>
                              <Row gutter={8}>
                                ...
                                <Col span={12}>
                                  <LogstoreSelect width='100%' datasourceCate={cate} datasourceName={_.join(cluster, ' ')} prefixField={field} prefixName={[field.name]} project={project} />
                                </Col>
                              </Row>
                            </Col>
                            <Col flex='360px'>
                        ...
                        display: 'flex'
                                ...
                                <InputGroupWithFormItem label={t("查询区间")} labelWidth={80}>
                                  <Form.Item {...field} name={[field.name, 'range']} initialValue={{
                            start: 'now-5m',
                            end: 'now'
                          }}>
